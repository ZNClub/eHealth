...
<!--[if lte IE 8]><script src="assets/js/ie/html5shiv.js"></script><![endif]-->
	...
	<article class="box post post-excerpt">
							<header>
								<h3 style="font-size:x-large">Upload Prescription</h3>
							</header>
							<hr>
	...
	<form class="form" action="UploadPrescription.do" method="post" autocomplete="on" enctype="multipart/form-data">
	<fieldset id="fset1" style="font-size:1.4em">
		...
		<label  for="upload-resdoc">Upload Prescription:</label><br>
