...
<!--[if lte IE 8]><script src="assets/js/ie/html5shiv.js"></script><![endif]-->
	...
	<article class="box post post-excerpt">
							<header>
								<h3 style="font-size:x-large">Test Offers are</h3>
							</header>
		...
		<div id="sidebar" >
            ...
            <script>$( document ).ready(function() {
						...
						$('#p1').hide();
						$('#p1').html("<i><b>Test type:</b></i>blood test<br><i><b>Price:</b></i>550<br><i><b>Valid Until:</b></i>30/10/2015<br><i><b>Lab name:</b></i>Nama<br>");
						$('#p1').show();
			});
