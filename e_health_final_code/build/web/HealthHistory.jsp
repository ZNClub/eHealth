...
<!--[if lte IE 8]><script src="assets/js/ie/html5shiv.js"></script><![endif]-->
	...
	<article class="box post post-excerpt">
							<header>
								<h3 style="font-size:x-large">Health Records</h3>
							</header>
							<hr>
							...
							line-height:2.9em;">
							<li>		
							View Doctor's Prescription<br>
							<form class="form" action="DownloadPrescription.do" method="post" autocomplete="on" enctype="multipart/form-data">
							<input class="small" type="submit" value="view"/>
							</form>
							</li>
							
							<li>		
							View Health Test Report<br>
							<form class="form" action="DownloadReport.do" method="post" autocomplete="on" enctype="multipart/form-data">
							<input class="small" type="submit" value="view"/>
							</form>
							</li>
