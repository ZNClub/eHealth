    ...
    <body>
        ...
        <div id="content">
            <div class="inner">
                ...
                <article class="box post post-excerpt">
                    <header>
                        <h3 style="font-size:x-large">Pathology Lab Report</h3>
                    </header>
                    <hr>
                    <div id="div1" style="color:#101;width:100%;max-width:100%;
                        ...
                        <ul class="" style="font-size:1.4em;color:#000;;
                            ...
                            <form class="form" action="DownloadServlet.do" method="post" autocomplete="on" >
                                <a href="" ><input style="background-color:#1C2139" class="big" type="submit" value="Download Report"/>
                            </form>
                        </ul>
