...
<!--[if lte IE 8]><script src="assets/js/ie/html5shiv.js"></script><![endif]-->
	...
	<article class="box post post-excerpt">
							<header>
								<h3 style="font-size:x-large">Test Offer</h3>
							</header>
							<hr>
							<div id="div1" style="color:#101;width:100%;max-width:100%;
							height:auto;max-height:auto;display:">
							
							
							
							<p style="font-size:1.4em;font-weight:bold">
							Test Offer uploaded successfully							
							</p>
							<ul class="" style="font-size:1.4em;color:#000;;
							line-height:2.9em;">
									<li>
									<p id="p1">
									<i>Test type:</i>$(Test.type)<br>
									<i>Price:</i>$(Test.price)<br>
									<i>Valid Until:</i>$(Test.validity)<br>
									<i>Lab name:</i>$(Test.labName)<br>
									</p>
							...
							<br>
							<a href="TestOffer.jsp" ><input style="background-color:#1C2139" class="big" type="submit" value="Upload more"/>
							</a>
							<hr>
							</div>
		...
		<div id="sidebar" style="" >
            ...
            <script>$( document ).ready(function() {
				...
				$('#p1').hide();
						$('#p1').html("<i><b>Test type:</b>&nbsp</i>blood test<br><i><b>Price:</b>&nbsp</i>550<br><i><b>Valid Until:</b>&nbsp</i>30/10/2015<br><i><b>Lab name:</b>&nbsp</i>Nama<br>");
						$('#p1').show();
			});
