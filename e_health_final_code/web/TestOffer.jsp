...
<!--[if lte IE 8]><script src="assets/js/ie/html5shiv.js"></script><![endif]-->
	...
	<form class="form" action="TestOfferSuccess.jsp" method="post" autocomplete="on" >
	<fieldset id="fset1" style="font-size:1.4em">
		...
		<!-- set jsp request property here -->
		
		
		<button class="small" id="btn-patho" type="submit">Submit Offer</button>
