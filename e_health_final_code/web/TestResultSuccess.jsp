...
<!--[if lte IE 8]><script src="assets/js/ie/html5shiv.js"></script><![endif]-->
	...
	<article class="box post post-excerpt">
							...
							<p id="up" style="font-size:1.4em;font-weight:bold">
							Test Result uploaded successfully for ID: $(Report.email)
							</p>
							<br>
							<a href="TestResult.jsp" ><input style="background-color:#1C2139" class="big" type="submit" value="Upload more"/>
							</a>
							<hr>
							</div>
		...
		<div id="sidebar" style="" >
            ...
            <script>$( document ).ready(function() {
				...
				$('#up').text("Test Result uploaded successfully for ID: cuthinho.crystal@gmail.com");
			});
